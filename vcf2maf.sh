...
sbatch --array=1-$FILE_NO --output=$SCRATCH/cbioportal_projects/logs/vcf2maf_%A_%a.out $SCRIPT_DIR/vcf2maf_slurm.sh -i $VEP_VCF_DIR/vcf_files.txt -o $TEMP_DIR/maf_files -r $REF_FASTA
